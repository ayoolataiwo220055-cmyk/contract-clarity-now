        ...
        <section className="py-12 lg:py-16">
          <div className="section-container">
            ...
            <div className="mx-auto max-w-2xl">
              ...
              {/* Privacy Notice */}
              <div className="mt-10 p-6 bg-muted/30 border border-border rounded-md opacity-0 animate-fade-in-up stagger-3">
              ...
              {/* Response Time */}
              <div className="mt-8 text-center opacity-0 animate-fade-in stagger-4">
