      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-muted/50 to-background py-20 lg:py-28">
        <div className="section-container">
          <div className="mx-auto max-w-3xl text-center animate-slide-up">
            ...
            <h1 className="mb-6 font-heading text-4xl font-semibold tracking-tight text-foreground sm:text-5xl lg:text-6xl">
        ...
        <div className="section-container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div 
                key={item.step}
                className="card-professional text-center animate-slide-up"
